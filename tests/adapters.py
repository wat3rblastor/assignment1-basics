...
def run_swiglu(
    ...
    swiglu = transformer.FeedForward(d_model, d_ff)
...
def run_multihead_self_attention(
    ...
    selfAttention.load_state_dict(state_dict)
    
    return selfAttention(in_features)
...
def run_multihead_self_attention_with_rope(
    ...
    return selfAttention(in_features, token_positions)
